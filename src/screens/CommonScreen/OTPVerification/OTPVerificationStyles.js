...
export const OTPVerificationStyles = StyleSheet.create({
    ...
    mainHeading: { fontSize: nf(22), fontFamily: fonts.semiBold, color: "#000", marginTop: hpx(33) },
    description: { fontSize: nf(15), fontFamily: fonts.regular, color: "#6F6F6F", width: wp(80), marginTop: hpx(5) },
